...
void practika_2_22()
{
	...
	cout << "Номер первого макс. элемента: " << a << endl << "Последнего: " << b;
}
void practika_2_23()
{
		setlocale(LC_ALL, "Russian");
...
{
	setlocale(LC_ALL, "Russian");
	cout << "Выберите задание из практики от 2.1 до 2.23( выбирайте последнее число, например для 2.1 пиши 1" << endl;
	cin >> practika;
	switch (practika)
	{
	...
	case 17: practika_2_17(); break;
	case 18: practika_2_18(); break;
	case 19: practika_2_19(); break;
	case 20: practika_2_20(); break;
	case 21: practika_2_21(); break;
	case 22: practika_2_22(); break;
	case 23: practika_2_23(); break;
